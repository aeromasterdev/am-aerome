...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "aerome " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
        {"aerome.publicvm.com", "aerome.publicvm.com"},
        {"aerome2.publicvm.com", "aerome2.publicvm.com"},
        {"aerome3.publicvm.com", "aerome3.publicvm.com"},
        {"aerome4.publicvm.com", "aerome4.publicvm.com"},
        {"aerome5.publicvm.com", "aerome5.publicvm.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("aerome-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. aerome is probably already running."), addrBind.ToString().c_str());
        else
