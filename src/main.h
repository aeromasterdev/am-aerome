...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.06 * COIN;	// 6%
...
static const uint256 hashGenesisBlock("000003eafd0c0dedb8eec65e52fca04907ec6cd6d25eea778bea25db254baa51");
static const uint256 hashGenesisBlockTestNet("000003eafd0c0dedb8eec65e52fca04907ec6cd6d25eea778bea25db254baa51");

static const uint256 fCheckPoint1 ("000000346c5fe29ade08a98db3f3760d2b8e5e4f5647c0a06744c9abd63fc123");
...
public:
    ...
    {
        // aerome: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // aerome: get transaction coin age
...
public:
    ...
    // aerome: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // aerome: two types of block: proof-of-work or proof-of-stake
    ...
    // aerome: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // aerome: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // aerome: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // aerome: block index flags
    enum  
    {
